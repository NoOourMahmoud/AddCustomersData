#module Features
  ...
  def expect_not_to_display_customer(mobile, name, address)
    expect(page).not_to have_css "h5", text: name
    expect(page).not_to have_css "p", text: mobile
    expect(page).not_to have_css "p", text: address
  end
